...
use App\Http\Controllers\Api\V1\DashboardController as DashboardApiController;
use App\Http\Controllers\Api\V1\CategoryController as CategoryApiController;
use App\Http\Controllers\Api\V1\ArticleController  as ArticleApiController;
use App\Http\Controllers\Api\V1\AdController as AdApiController;
use App\Http\Controllers\Api\V1\MediaController as MediaApiController;
use App\Http\Controllers\Api\V1\MenuController as MenuApiController;
use App\Http\Controllers\Api\V1\PageController as PageApiController;
...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    // api.v1.articles.show    GET    /api/v1/articles/{article}
    // api.v1.articles.update  PUT    /api/v1/articles/{article}
    // api.v1.articles.destroy DELETE /api/v1/articles/{article}
