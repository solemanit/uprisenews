{{-- resources/views/pages/employee-records/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Add Employee Record')
@section('page_title', 'Add Employee Record')
...
@section('content')
    <div class="row justify-content-center">
        <div class="col-xl-10">
            <form action="{{ route('employee-records.store') }}" method="POST" id="recordForm" novalidate>
                @csrf
                    ...
                    <div class="card-body pt-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="translatable-wrap">
                                    <input type="text" id="company_name" name="company_name"
                                        ...
                                        value="{{ old('company_name') }}" placeholder="e.g. Acme Corporation" required
                                        autocomplete="off" data-translate-target="company_name_ar">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold" for="company_name_ar">
                                    ...
                                    <span class="badge bg-info text-dark ms-1"
                                        style="font-size:.7rem;">Auto-translated</span>
                                </label>
                                <input type="text" name="company_name_ar" id="company_name_ar" class="form-control"
                                    dir="rtl" placeholder="Company name in Arabic" readonly>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="translatable-wrap">
                                    <input type="text" id="applicant" name="applicant"
                                        ...
                                        value="{{ old('applicant') }}" placeholder="Applicant full name" autocomplete="off"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="applicant_ar" id="applicant_ar" class="form-control"
                                    dir="rtl" placeholder="Applicant name in Arabic" readonly>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="subscriber_id" name="subscriber_id"
                                    ...
                                    value="{{ old('subscriber_id') }}" placeholder="Subscriber ID">
                                @error('subscriber_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="unified_number" name="unified_number"
                                    ...
                                    value="{{ old('unified_number') }}" placeholder="Unified Number">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="cr_number" name="cr_number"
                                    ...
                                    value="{{ old('cr_number') }}" placeholder="C.R Number">
                                @error('cr_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="phone_number" name="phone_number"
                                    ...
                                    value="{{ old('phone_number') }}" placeholder="+966 5x xxx xxxx">
                                @error('phone_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="request_number" name="request_number"
                                    ...
                                    value="{{ old('request_number') }}" placeholder="Request Number">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="employee" name="employee"
                                    ...
                                    value="{{ old('employee') }}" placeholder="Employee">
                                @error('employee')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="editor" name="letter_content" rows="3"
                                    class="form-control @error('letter_content') is-invalid @enderror" placeholder="Letter content">{{ old('letter_content') }}</textarea>
    ...
    <script>
        $(function() {
            ...
            document.querySelectorAll('[data-translate-target]').forEach(function(sourceEl) {
                ...
                // Trigger on load if old() value is present
