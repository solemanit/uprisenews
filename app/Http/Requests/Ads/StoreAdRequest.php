...
class StoreAdRequest extends FormRequest
{
    ...
    {
        return [
            'image.required_if'       => 'Please upload an image for image-type ads.',
            'target_url.required_if'  => 'A target URL is required for image-type ads.',
            'script_code.required_if' => 'Script code is required for script-type ads.',
            'html_code.required_if'   => 'HTML code is required for html-type ads.',
        ];
    }
}
